...
app.get('/queryallemp', async (req, res) => {

  let networkObj = await network.connectToNetwork(appAdmin);
  let response = await networkObj.contract.evaluateTransaction('querryallemp');
...
app.post('/createemp', async (req, res) => {
  ...
  console.log(req.body);
    ...
    let invokeResponse = await networkObj.contract.submitTransaction('createEmp', req.body.empId, req.body.name, req.body.school, req.body.college, req.body.usn, req.body.company, req.body.schoolValidate, req.body.usnValidate, req.body.collegeValidate, req.body.companyValidate);
...
app.get('/queryemp', async (req, res) => {

  let networkObj = await network.connectToNetwork(appAdmin);
  let response = await networkObj.contract.evaluateTransaction('queryData', req.body.empId);
...
app.post('/validation', async (req, res) => {
  ...
  console.log(req.body);
    ...
    let invokeResponse = await networkObj.contract.submitTransaction('validation', req.body.empId, "1");
